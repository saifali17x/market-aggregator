...
const products = [
  ...
  },
  {
    ...
    views: 9870,
    sales: 156,
    description: "Experience powerful cleaning with the Dyson V15 Detect. Features laser dust detection, 60-minute runtime, and advanced filtration for a cleaner home.",
    features: [
  ...
  },
  {
    ...
    views: 6540,
    sales: 89,
    description: "Versatile KALLAX shelf unit perfect for organizing any room. Features a clean, modern design with multiple storage compartments.",
    features: [
      "Clean modern design",
      "Multiple compartments",
      "Easy assembly",
  ...
  // ===== SPORTS CATEGORY =====
  {
    ...
    views: 7890,
    sales: 67,
    description: "Professional-grade tennis racket used by top players. Features advanced technology for power, control, and feel on every shot.",
    features: [
      "Professional grade",
      "Advanced technology",
      "Power and control",
  ...
  },
  {
    ...
    views: 12340,
    sales: 234,
    description: "Stay comfortable during your workout with Nike Dri-FIT training shorts. Features moisture-wicking technology and a comfortable fit for any activity.",
    features: [
      "Dri-FIT technology",
      "Moisture wicking",
      "Comfortable fit",
  ...
  // ===== BOOKS CATEGORY =====
  {
    ...
    views: 23450,
    sales: 567,
    description: "Timeless lessons on wealth, greed, and happiness. A must-read for anyone interested in understanding the psychology behind financial decisions.",
    features: [
  ...
  },
  {
    ...
    views: 45670,
    sales: 890,
    description: "Transform your life with tiny changes that lead to remarkable results. Learn how to build good habits and break bad ones.",
    features: [
      "Proven strategies",
      "Easy to implement",
  ...
  // ===== AUTOMOTIVE CATEGORY =====
  {
    ...
    views: 8920,
    sales: 89,
    description: "Ultra-high performance summer tires designed for sports cars and high-performance vehicles. Features advanced compound technology for exceptional grip.",
    features: [
  ...
  },
  {
    ...
    views: 12340,
    sales: 156,
    description: "Capture every moment on the road with 4K Ultra HD recording. Features GPS tracking, voice control, and automatic incident detection.",
    features: [
